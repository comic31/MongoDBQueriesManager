...
class TestTypes:
    ...
    def test_type_string(self):
        ...
        assert query_result == {'filter': {"name": 'toto'}, 'sort': None, 'skip': 0, 'limit': 0}
    ...
    def test_type_float(self):
        ...
        assert query_result == {'filter': {"price": 5.5}, 'sort': None, 'skip': 0, 'limit': 0}
    ...
    def test_type_list(self):
        ...
        assert query_result == {'filter': {"country": {"$in": ['US', 'RU']}}, 'sort': None, 'skip': 0, 'limit': 0}
    ...
    def test_type_boolean_false(self):
        ...
        assert query_result == {'filter': {"active": {'$ne': False}}, 'sort': None, 'skip': 0, 'limit': 0}
    ...
    def test_type_null(self):
        ...
        assert query_result == {'filter': {"active": {'$ne': None}}, 'sort': None, 'skip': 0, 'limit': 0}
